          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Предоставляем полный спектр транспортных и складских услуг с гарантией качества и своевременной доставки
              </p>
        ...
        <section className="py-16 bg-secondary">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { icon: 'Clock', title: '15+ лет опыта', desc: 'На рынке логистических услуг' },
                { icon: 'TrendingUp', title: '5000+ заказов', desc: 'Успешно выполнено в этом году' },
                { icon: 'Shield', title: '100% гарантия', desc: 'Сохранности вашего груза' }
              ].map((stat, idx) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground text-center mb-12 leading-relaxed">
                ТрансЛогистик — ведущий поставщик транспортных и складских решений для бизнеса любого масштаба
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card className="p-8 hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Обеспечивать бесперебойную работу вашего бизнеса через качественную логистику, 
                    современные технологии и персональный подход к каждому клиенту
                  </p>
                </Card>
              ...
              <div className="bg-secondary rounded-xl p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    ...
                    'Складские комплексы общей площадью 50 000 м²',
        ...
        <section id="services" className="py-24 bg-secondary">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg text-muted-foreground text-center mb-16 max-w-2xl mx-auto">
              Комплексные решения для эффективной логистики вашего бизнеса
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Автомобильные перевозки по России и СНГ. Доставка грузов любого объёма и сложности с гарантией сохранности.',
                  features: ['До 20 тонн', 'Экспресс-доставка', 'Межрегиональные маршруты']
                },
                {
                  icon: 'Warehouse',
                  title: 'Складское хранение',
                  desc: 'Современные складские комплексы с системой климат-контроля и круглосуточной охраной.',
                  features: ['От 1 м² до 10 000 м²', 'Длительное хранение', 'Системы безопасности']
                },
                {
                  icon: 'Package',
                  title: 'Комплектация заказов',
                  desc: 'Сборка, упаковка и маркировка товаров для дальнейшей отправки вашим клиентам.',
                  features: ['Профессиональная упаковка', 'Маркировка', 'Контроль качества']
                },
                {
                  icon: 'BarChart3',
                  title: 'Складская логистика',
                  desc: 'Оптимизация складских процессов с использованием WMS-систем для максимальной эффективности.',
                  features: ['Автоматизация', 'Инвентаризация', 'Аналитика']
                },
                {
                  icon: 'Globe',
                  title: 'Международная доставка',
                  desc: 'Организация международных перевозок с таможенным оформлением и сопровождением грузов.',
                  features: ['Таможенная очистка', 'Страхование', 'Документооборот']
                },
                {
                  icon: 'Settings',
                  title: 'Индивидуальные решения',
                  desc: 'Разработка персональных логистических схем под уникальные требования вашего бизнеса.',
